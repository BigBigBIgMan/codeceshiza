...
//  BylibKjc
//
//  Created by iOSRos on 2022/5/25.
...
@interface BylibKjc : NSObject

@end

@implementation BylibKjc
...
CHConstructor // code block that runs immediately upon load
{
	@autoreleasepool
	{
		...
		// this would be posted using: notify_post("iOSPubgGame.cn.BylibKjc.eventname");
		CFNotificationCenterRef darwin = CFNotificationCenterGetDarwinNotifyCenter();
		CFNotificationCenterAddObserver(darwin, NULL, ExternallyPostedNotification, CFSTR("iOSPubgGame.cn.BylibKjc.eventname"), NULL, CFNotificationSuspensionBehaviorCoalesce);
